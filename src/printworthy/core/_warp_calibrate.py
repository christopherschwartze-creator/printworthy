...
CLI:
  python -m printworthy.core._warp_calibrate --measured 0.8 --bar 100x30x6 --material PLA --label Ender3-PLA
  python -m printworthy.core._warp_calibrate --selftest
  python -m printworthy.core._warp_calibrate --list
...
# The WRITABLE calibration store lives in the user's data dir (~/.printworthy/),
# never inside site-packages. The bundled (read-only, usually empty) package
# data file serves only as a seed/fallback for reads.
CALIB_PATH = os.path.join(os.path.expanduser("~"), ".printworthy",
