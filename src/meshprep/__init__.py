"""meshprep — drop a mesh, get a print-ready package + a plain-English report.

Product layer (pipeline/report/profiles/cli/app) sits on top of the vendored,
validated engines in `meshprep.core`.
"""
import os as _os
...
def prep(*args, **kwargs):
    ...
    See :func:`meshprep.pipeline.prep` for the full signature (lazy import so
    `import meshprep` stays instant)."""
